            ...
            <editor-fold defaultstate="collapsed" >
                <div id="editcust" >
                    <form action="admincustomer" method="POST">
                        ...
                        <div class="w3-container">
                            <%Customer cust = (Customer) session.getAttribute("selectedCust");%>
                            <label for="uname"><b>First Name</b></label></br>
                            <input type="text" placeholder="<%= cust.getFirstName()%>" name="fnupd" required></br></br>

                            <label for="uname"><b>Last Name</b></label></br>
                            <input type="text" placeholder="<%= cust.getLastName()%>" name="lnupd" required></br></br>

                            <label for="uname"><b>Telephone(Home)</b></label></br>
                            <input type="text" placeholder="<%= cust.getTelephonehome()%>" name="thupd" required></br></br>

                            <label for="uname"><b>Telephone(Mobile)</b></label></br>
                            <input type="text" placeholder="<%= cust.getTelephonemobile()%>" name="tmupd" required></br></br>

                            <label for="uname"><b>Customer ID Number</b></label></br>
                            <input type="text" placeholder="<%= cust.getID()%>" name="idnupd" required></br></br>

                            <label for="uname"><b>Customer Address</b></label></br>
                            <input type="text" placeholder="<%= cust.getAddressId()%>" name="addrupd" required></br></br>

                            <label for="uname"><b>Email Address</b></label></br>
                            <input type="text" placeholder="<%= cust.getEmail()%>" name="emupd" required></br></br>

                            <label for="uname"><b>Password</b></label></br>
                            <input type="password" placeholder="Enter New Password" name="pwupd" required></br></br>

                            <button type="submit" name="custbut" value="Update">Update</button>
                        </div>
                    </form>
                </div>
            </editor-fold>
