            ...
            <editor-fold defaultstate="collapsed" >
                <div id="adding" >
                    <form action="adminingredient" method="POST">
                        <div class="w3-container">
                            <h2>Create new Ingredient</h2></br>
                        </div>

                        <div class="w3-container">
                            <label for="uname"><b>Ingredient Name</b></label></br>
                            <input type="text" placeholder="Enter Name" name="ingname" required></br></br>

                            <label for="psw"><b>Quantity</b></label></br>
                            <input type="text" placeholder="Enter Quantity" name="ingquan" required></br></br>
                            ...
                            <button type="submit" name="ingbut" value="Add Ingredient" >Add Ingredient</button>
                        </div>
                    </form>
                </div>
            </editor-fold>
