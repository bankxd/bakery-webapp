            ...
            <editor-fold defaultstate="collapsed" desc="products">
                <div id="editacc" >
                    <form action="adminproduct" method="POST">
                        ...
                        <div class="w3-container">
                            <%Product prod = (Product) session.getAttribute("selectedProd");%>
                            <label for="uname"><b>Name</b></label></br>
                            <input type="text" placeholder="<%=prod.getProductName()%>" name="prodnameupd" required></br></br>

                            <label for="uname"><b>Description</b></label></br>
                            <input type="text" placeholder="<%=prod.getProductDescription()%>" name="proddescupd" required></br></br>

                            <label for="psw"><b>Warnings/Allergens</b></label></br>
                            <input type="text" placeholder="<%=prod.getProductWarnings()%>" name="pwupd" required></br></br>

                            <label for="psw"><b>Price</b></label></br>
                            <input type="text" placeholder="<%=prod.getPrice()%>" name="prodpriceupd" required></br></br>

                            <label for="psw"><b>Discount</b></label></br>
                            <input type="text" placeholder="<%=prod.getDiscount()%>" name="proddiscupd" required></br></br>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td><input type="checkbox" placeholder="Enter Ingredients" name="prodingupd" ><%= ing.getIngredientName()%></td>
                                    <td></td>
                                    <td><input type="text" placeholder="0" name="prodingquan"></td>
                                </tr>
                                <% }%>
                            </table>
                            ...
                            <button type="submit" name="prodbut" value="Update">Update</button>
                        </div>
                    </form>
                </div>
            </editor-fold>
