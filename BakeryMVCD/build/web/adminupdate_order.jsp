            ...
            <editor-fold defaultstate="collapsed" >
                <div id="editing" >
                    <form action="adminorder" method="POST">
                        ...
                        <div class="w3-container">
                            <%Order ord = (Order) session.getAttribute("selectedOrd");%>
                            <label for="uname"><b>Delivery Address</b></label></br>
                            <input type="text" value="<%= ord.getDeliveryAddressId()%>" name="orddeladdupd" ></br></br>

                            <label for="uname"><b>Order Status</b></label></br>
                            <div style="padding: 40px;">
                                <input type="radio" placeholder=" RECEIVED " name="ordstatus" value="RECEIVED">RECEIVED<br>
                                <input type="radio" placeholder=" PREPARING " name="ordstatus" value="PREPARING">PREPARING<br>
                                <input type="radio" placeholder=" DELIVERING" name="ordstatus" value="DELIVERING">DELIVERING<br>
                            </div>

                            <label for="uname"><b>Order Total price</b></label></br>
                            <input type="text" placeholder="<%= ord.getTotalPrice()%>" name="ordpriceupd" ></br></br>

                            <button type="submit" name="ordbut" value="Update">Update</button>
                        </div>
                    </form>
                </div>
            </editor-fold>
