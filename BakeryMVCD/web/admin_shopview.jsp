    ...
    <editor-fold defaultstate="collapsed" desc="Sign In">
        ...
        <style>
            ...
            .bgimg-2{
                ...
                background-size: cover;
                background-image: url("Images/blurcook.jpg");
                min-height: 100%;
                overflow: auto;
...
<editor-fold defaultstate="collapsed" desc="">
    <div class="w3-top" style="opacity: 0.8">
        <div class="w3-bar w3-black w3-card" id="myNavbar">
            <div class="w3-bar-item w3-button w3-wide">
                <a href="admin.jsp"><img src="Images/pretzellogo.png" id="navpic"/><a/>
            </div>
            <!-- Right-sided navbar links -->
            <div class="w3-right w3-hide-small" style="font-family: Playfair Display; font-size: 19px;">
                <a href="admin.jsp" class="w3-bar-item w3-button">DASHBOARD</a>
                ...
                <div class="w3-dropdown-click">
                    ...
                    <div id="acco" class="w3-dropdown-content w3-bar-block w3-border">
                        ...
                        <a href="" class="w3-bar-item w3-button w3-black" onclick="">My Account</a>
                        <a href="" class="w3-bar-item w3-button" onclick="">View Order History</a>
                        <form action="" method="">
                            <a href="" class="w3-bar-item w3-button"><button type="">Log Out</button></a>
                        </form>
                    </div>
                </div>
                <a href="" onclick="" class="w3-bar-item w3-button"><i class="fa fa-cart-arrow-down"></i> CART</a>
            </div>
        </div>
    ...
    <nav class="w3-sidebar w3-bar-block w3-black w3-card w3-animate-left w3-hide-medium w3-hide-large" style="display:none" id="mySidebar">
        ...
        <a href="" onclick="w3_close()" class="w3-bar-item w3-button">SHOP</a>
    ...
    <header class="bgimg-1 w3-display-container" id="home"style="padding-top: 20px;">
                ...
                <div class="flip-card" style="margin: auto;border-radius: 20px;" >
                    <div class="flip-card-inner"style="border-radius: 20px;">
                        ...
                        <div class="flip-card-back"style="border-radius: 20px;">
                            ...
                            <div>
                                <a href="" type="button" ><button>Add to Cart</button></a>
                            </div>
                        </div>
                    </div>
                </div></br>
