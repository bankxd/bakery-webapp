            ...
            <editor-fold defaultstate="collapsed" >
                <div id="editing" >
                    <form action="adminingredient" method="POST">
                        <div class="w3-container">
                            <h2>Update Ingredient</h2></br>
                        </div>

                        <div class="w3-container">
                            <%Ingredient ing = (Ingredient) session.getAttribute("selectedIng");%>
                            <label for="uname"><b>First Name</b></label></br>
                            <input type="text" placeholder="<%= ing.getIngredientName()%>" name="ingnameupd" required></br></br>

                            <label for="uname"><b>Last Name</b></label></br>
                            <input type="text" placeholder="<%= ing.getQuantity()%>" name="ingquanupd" required></br></br>

                            <label for="psw"><b>Unit of Measurement</b></label></br>
                            <div style="padding: 40px;">
                                <input type="radio" name="uom" value="kilograms" required>       Kilograms</br></br>
                                <input type="radio" name="uom" value="grams" required>        Grams</br></br>
                            </div>

                            <button type="submit" name="ingbut" value="Update">Update</button>
                        </div>
                    </form>
                </div>
            </editor-fold>
