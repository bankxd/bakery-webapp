        ...
        <div class="w3-main" style="margin-left:340px;margin-right:40px">
            ...
            <editor-fold defaultstate="collapsed" >
                <div id="accinfo" style="padding-left: 100px;padding-top: 1px;">
                    ...
                    <h2>Your Account : <%= cust.getEmail()%></h2></br>

                    <table>
                        <tr><td><label for="fn"><b><%= cust.getFirstName()%></b></label></br></td></tr>
                        <tr><td><label for="ln"><b><%= cust.getLastName()%></b></label></br></td></tr>
                        <tr><td><label for="tel"><b><%= cust.getTelephonehome()%></b></label></br></td></tr>
                        <tr><td><label for="telm"><b><%= cust.getTelephonemobile()%></b></label></br></td></tr>
                        <tr><td><label for="em"><b><%= cust.getAddressId()%></b></label></br></td></tr>
                        <tr><td><label for="em"><b><%= cust.getEmail()%></b></label></br></td></tr>
                    </table><br><br>
                    <div>
                        <form action="account" method="GET">
                            <input type="hidden" name="custID" value="<%= cust.getCustomerId()%>">
                            <button type="submit" name="custdetupdbut" value="Update">Edit Details</button>
                        </form>
                    </div>
                </div>
        </div>
