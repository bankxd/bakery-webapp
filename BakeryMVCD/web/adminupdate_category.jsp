            ...
            <editor-fold defaultstate="collapsed" >
                <div id="editcat" >
                    <form action="admincategory" method="POST">
                        ...
                        <div class="w3-container">
                            <% Category cat = (Category) session.getAttribute("selectedCat");%>
                            <form action="admincategory" method="POST">
                                <label for="uname"><b>First Name</b></label></br>
                                <input type="text" placeholder="<%= cat.getCategoryName()%>" name="catnameupd" required></br></br>
                                <button type="submit" name="catbut" value="Update">Update</button>
                            </form>
                        </div>
                    </form>
                </div>
