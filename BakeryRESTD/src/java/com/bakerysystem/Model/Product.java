...
import java.util.ArrayList;
   ...
   public class Product implements Serializable {
    ...
    public String toString() {
        return "Product{" + "productID:" + productID + ", productName:" + productName + ", photo:" + photo + ", recipeArr:" + recipeArr + ", productDescription:" + productDescription + ", productWarnings:" + productWarnings + ", price:" + price + ", actualPrice:" + actualPrice + ", discount:" + discount + ", categoryID:" + categoryID + '}';
    }
